...
public sealed class UpdateAdminSettingsEndpointResult : EndpointResponse, IUpdateAdminSettingsEndpointResult
{
    ...
    /// </summary>
    public static UpdateAdminSettingsEndpointResult Ok(AdminSettings content)
        => Create(HttpStatusCode.OK, content);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static UpdateAdminSettingsEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP Unauthorized.
    /// </summary>
    public static UpdateAdminSettingsEndpointResult Unauthorized(ProblemDetails content)
        => Create(HttpStatusCode.Unauthorized, content);

    /// <summary>
    /// Creates a result representing HTTP Forbidden.
    /// </summary>
    public static UpdateAdminSettingsEndpointResult Forbidden(ProblemDetails content)
        => Create(HttpStatusCode.Forbidden, content);

    /// <summary>
    /// Creates a result representing HTTP Conflict.
    /// </summary>
    public static UpdateAdminSettingsEndpointResult Conflict(ProblemDetails content)
        => Create(HttpStatusCode.Conflict, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static UpdateAdminSettingsEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static UpdateAdminSettingsEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static UpdateAdminSettingsEndpointResult Create(
