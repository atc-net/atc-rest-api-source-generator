...
public partial class GetProductByIdEndpointResult : EndpointResponse, IGetProductByIdEndpointResult
{
    ...
    /// </summary>
    public static GetProductByIdEndpointResult Ok(Product content)
        => Create(HttpStatusCode.OK, content);

    /// <summary>
    /// Creates a result representing HTTP NotFound.
    /// </summary>
    public static GetProductByIdEndpointResult NotFound(ProblemDetails content)
        => Create(HttpStatusCode.NotFound, content);

    /// <summary>
    /// Creates a result representing HTTP Unauthorized.
    /// </summary>
    public static GetProductByIdEndpointResult Unauthorized(ProblemDetails content)
        => Create(HttpStatusCode.Unauthorized, content);

    /// <summary>
    /// Creates a result representing HTTP Forbidden.
    /// </summary>
    public static GetProductByIdEndpointResult Forbidden(ProblemDetails content)
        => Create(HttpStatusCode.Forbidden, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static GetProductByIdEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static GetProductByIdEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static GetProductByIdEndpointResult Create(
