...
export type ApiResult<T> =
  ...
  | { status: 'schemaMismatch'; issues: ZodIssue[]; data: unknown; response: Response };
...
export function isSchemaMismatch<T>(result: ApiResult<T>): result is { status: 'schemaMismatch'; issues: import('zod').ZodIssue[]; data: unknown; response: Response } {
  return result.status === 'schemaMismatch';
}