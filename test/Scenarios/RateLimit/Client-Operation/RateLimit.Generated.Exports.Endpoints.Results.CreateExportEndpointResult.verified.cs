...
public partial class CreateExportEndpointResult : EndpointResponse, ICreateExportEndpointResult
{
    ...
    /// </summary>
    public static CreateExportEndpointResult Accepted(ExportJob content)
        => Create(HttpStatusCode.Accepted, content);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static CreateExportEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP Conflict.
    /// </summary>
    public static CreateExportEndpointResult Conflict(ProblemDetails content)
        => Create(HttpStatusCode.Conflict, content);

    /// <summary>
    /// Creates a result representing HTTP TooManyRequests.
    /// </summary>
    public static CreateExportEndpointResult TooManyRequests(ProblemDetails content)
        => Create(HttpStatusCode.TooManyRequests, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static CreateExportEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static CreateExportEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static CreateExportEndpointResult Create(
