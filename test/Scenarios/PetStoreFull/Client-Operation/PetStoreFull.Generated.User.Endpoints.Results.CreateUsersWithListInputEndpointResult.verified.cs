...
public partial class CreateUsersWithListInputEndpointResult : EndpointResponse, ICreateUsersWithListInputEndpointResult
{
    ...
    /// </summary>
    public static CreateUsersWithListInputEndpointResult Ok(User content)
        => Create(HttpStatusCode.OK, content);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static CreateUsersWithListInputEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP Conflict.
    /// </summary>
    public static CreateUsersWithListInputEndpointResult Conflict(ProblemDetails content)
        => Create(HttpStatusCode.Conflict, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static CreateUsersWithListInputEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static CreateUsersWithListInputEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static CreateUsersWithListInputEndpointResult Create(
