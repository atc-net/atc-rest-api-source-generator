...
public partial class CreateTestItemEmptyEndpointResult : EndpointResponse, ICreateTestItemEmptyEndpointResult
{
    ...
    /// </summary>
    public static CreateTestItemEmptyEndpointResult Created()
        => Create(HttpStatusCode.Created, contentObject: null);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static CreateTestItemEmptyEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP Conflict.
    /// </summary>
    public static CreateTestItemEmptyEndpointResult Conflict(ProblemDetails content)
        => Create(HttpStatusCode.Conflict, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static CreateTestItemEmptyEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static CreateTestItemEmptyEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static CreateTestItemEmptyEndpointResult Create(
