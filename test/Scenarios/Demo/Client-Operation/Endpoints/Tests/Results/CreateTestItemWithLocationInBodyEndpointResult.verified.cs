...
public partial class CreateTestItemWithLocationInBodyEndpointResult : EndpointResponse, ICreateTestItemWithLocationInBodyEndpointResult
{
    ...
    /// </summary>
    public static CreateTestItemWithLocationInBodyEndpointResult Created(Uri content)
        => Create(HttpStatusCode.Created, content);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static CreateTestItemWithLocationInBodyEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP Conflict.
    /// </summary>
    public static CreateTestItemWithLocationInBodyEndpointResult Conflict(ProblemDetails content)
        => Create(HttpStatusCode.Conflict, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static CreateTestItemWithLocationInBodyEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static CreateTestItemWithLocationInBodyEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static CreateTestItemWithLocationInBodyEndpointResult Create(
