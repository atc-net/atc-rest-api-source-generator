...
public partial class UploadFormDataFileEndpointResult : EndpointResponse, IUploadFormDataFileEndpointResult
{
    public UploadFormDataFileEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    /// </summary>
    public static UploadFormDataFileEndpointResult Ok()
        => Create(HttpStatusCode.OK, contentObject: null);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static UploadFormDataFileEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP Conflict.
    /// </summary>
    public static UploadFormDataFileEndpointResult Conflict(ProblemDetails content)
        => Create(HttpStatusCode.Conflict, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static UploadFormDataFileEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static UploadFormDataFileEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static UploadFormDataFileEndpointResult Create(
