...
public partial class UploadSingleFileAsFormDataEndpointResult : EndpointResponse, IUploadSingleFileAsFormDataEndpointResult
{
    ...
    /// </summary>
    public static UploadSingleFileAsFormDataEndpointResult Ok()
        => Create(HttpStatusCode.OK, contentObject: null);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static UploadSingleFileAsFormDataEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP Conflict.
    /// </summary>
    public static UploadSingleFileAsFormDataEndpointResult Conflict(ProblemDetails content)
        => Create(HttpStatusCode.Conflict, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static UploadSingleFileAsFormDataEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static UploadSingleFileAsFormDataEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static UploadSingleFileAsFormDataEndpointResult Create(
