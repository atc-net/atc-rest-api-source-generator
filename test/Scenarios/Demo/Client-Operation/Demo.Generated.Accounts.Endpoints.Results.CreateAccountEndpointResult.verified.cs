...
public partial class CreateAccountEndpointResult : EndpointResponse, ICreateAccountEndpointResult
{
    ...
    /// </summary>
    public static CreateAccountEndpointResult Created(Account content)
        => Create(HttpStatusCode.Created, content);

    /// <summary>
    /// Creates a result representing HTTP Conflict.
    /// </summary>
    public static CreateAccountEndpointResult Conflict(ProblemDetails content)
        => Create(HttpStatusCode.Conflict, content);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static CreateAccountEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static CreateAccountEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static CreateAccountEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static CreateAccountEndpointResult Create(
