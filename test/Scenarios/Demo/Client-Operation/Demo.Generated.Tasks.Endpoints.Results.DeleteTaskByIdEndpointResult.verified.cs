...
public partial class DeleteTaskByIdEndpointResult : EndpointResponse, IDeleteTaskByIdEndpointResult
{
    ...
    /// </summary>
    public static DeleteTaskByIdEndpointResult NoContent()
        => Create(HttpStatusCode.NoContent, contentObject: null);

    /// <summary>
    /// Creates a result representing HTTP NotFound.
    /// </summary>
    public static DeleteTaskByIdEndpointResult NotFound(ProblemDetails content)
        => Create(HttpStatusCode.NotFound, content);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static DeleteTaskByIdEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static DeleteTaskByIdEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static DeleteTaskByIdEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static DeleteTaskByIdEndpointResult Create(
