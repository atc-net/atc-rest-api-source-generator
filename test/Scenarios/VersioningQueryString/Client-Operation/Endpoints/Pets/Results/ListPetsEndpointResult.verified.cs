...
public sealed class ListPetsEndpointResult : EndpointResponse, IListPetsEndpointResult
{
    ...
    /// </summary>
    public static ListPetsEndpointResult Ok(IEnumerable<Pet> content)
        => Create(HttpStatusCode.OK, content);

    /// <summary>
    /// Creates a result representing HTTP BadRequest.
    /// </summary>
    public static ListPetsEndpointResult BadRequest(ValidationProblemDetails content)
        => Create(HttpStatusCode.BadRequest, content);

    /// <summary>
    /// Creates a result representing HTTP InternalServerError.
    /// </summary>
    public static ListPetsEndpointResult InternalServerError(ProblemDetails content)
        => Create(HttpStatusCode.InternalServerError, content);

    /// <summary>
    /// Creates a result representing HTTP GatewayTimeout.
    /// </summary>
    public static ListPetsEndpointResult GatewayTimeout(ProblemDetails content)
        => Create(HttpStatusCode.GatewayTimeout, content);

    private static ListPetsEndpointResult Create(
