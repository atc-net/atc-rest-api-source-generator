...
export class FilesClient {
  ...
  async uploadSingleObjectWithFileAsFormData(data: { itemName?: string; file?: Blob | File; items?: string[] }): Promise<ApiResult<void>> {
  ...
  async uploadSingleObjectWithFilesAsFormData(data: { files?: (Blob | File)[] }): Promise<ApiResult<void>> {
