...
import type { CreateSubscriptionRequest, NotificationEvents, Subscription, Subscriptions } from '../models';
...
export class NotificationsClient {
  ...
  async *listNotifications(query?: { topics?: string }, signal?: AbortSignal): AsyncGenerator<NotificationEvents> {
    yield* this.api.requestStream<NotificationEvents>('GET', '/notifications/stream', {
      query: {
        topics: query?.topics,
      },
      signal,
