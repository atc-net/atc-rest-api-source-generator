...
export type ListPaginatedAccountsResult =
  | { status: 'ok'; data: PaginatedResult<Accounts>; response: AxiosResponse }
  | { status: 'parseError'; error: Error; response: AxiosResponse };
