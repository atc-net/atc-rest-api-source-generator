...
namespace Atc.CodeGeneration.CSharp.CodeDocumentation.CodeComment;
...
public class CodeDocumentationTagsGenerator : ICodeDocumentationTagsGenerator
{
        ...
        IReadOnlyDictionary<string, string> parameters)
    {
        ...
        {
            sb.AppendLine(indentSpaces, $"/// <param name=\"{parameter.Key}\">{parameter.Value.EnsureEndsWithDot()}</param>");
        }
