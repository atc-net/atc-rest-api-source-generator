        ...
        foreach (var validationAttribute in validationAttributes)
        {
            switch (validationAttribute)
            {
                case StringLengthAttribute stringLengthAttribute:
                    result.Add(new AttributeParameters("StringLength", stringLengthAttribute.MaximumLength.ToString(GlobalizationConstants.EnglishCultureInfo)));
                    break;
                case MinLengthAttribute minLengthAttribute:
                    result.Add(new AttributeParameters("MinLength", minLengthAttribute.Length.ToString(GlobalizationConstants.EnglishCultureInfo)));
                    break;
                case MaxLengthAttribute maxLengthAttribute:
                    result.Add(new AttributeParameters("MaxLength", maxLengthAttribute.Length.ToString(GlobalizationConstants.EnglishCultureInfo)));
                    break;
