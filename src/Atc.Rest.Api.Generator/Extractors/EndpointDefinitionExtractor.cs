...
",
        ...
        string? defaultApiVersion = null)
    {
        ...
        var headerContent = GenerateHeaderContent(projectName, pathSegment, useMinimalApiPackage, useValidationFilter, versioningStrategy, hasOutputCaching);
        var namespaceValue = NamespaceBuilder.ForEndpoints(projectName, pathSegment);
        ...
        bool hasOutputCaching = false)
    {
        ...
        sb.AppendLine($"using {projectName}.Generated{segmentPart}.Handlers;");
        sb.AppendLine($"using {projectName}.Generated{segmentPart}.Models;");
        sb.AppendLine($"using {projectName}.Generated{segmentPart}.Parameters;");
        sb.AppendLine($"using {projectName}.Generated{segmentPart}.Results;");
