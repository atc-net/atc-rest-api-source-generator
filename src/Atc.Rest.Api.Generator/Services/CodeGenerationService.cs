...
public static class CodeGenerationService
{
        ...
        SystemTypeConflictResolver systemTypeResolver)
    {
        ...
        builder.AppendLine($"using {projectName}.Generated.{pathSegment}.Handlers;");
        builder.AppendLine($"using {projectName}.Generated.{pathSegment}.Models;");
        builder.AppendLine($"using {projectName}.Generated.{pathSegment}.Parameters;");
        builder.AppendLine($"using {projectName}.Generated.{pathSegment}.Results;");
        builder.AppendLine();
